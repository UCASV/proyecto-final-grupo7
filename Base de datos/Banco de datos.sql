...
--Creacion de llaves foraneas
 ...
 ALTER TABLE APPOINTMENT ADD FOREIGN KEY (id_place_vaccination) REFERENCES PLACE_VACCINATION(id);
 ALTER TABLE VACCINATION ADD FOREIGN KEY (id_effect_secondary) REFERENCES EFFECT_SECONDARY(id); 
 ALTER TABLE VACCINATION ADD FOREIGN KEY (id_appointment) REFERENCES APPOINTMENT(id);
